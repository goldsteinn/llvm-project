#ifndef LLVM_TRANSFORMS_UTILS_COLLECTCALLSITEATTRS_H
#define LLVM_TRANSFORMS_UTILS_COLLECTCALLSITEATTRS_H
...
class CollectCallsiteAttrs {
  ...
  struct CallsiteInfos {
    ...
    uint16_t NonSpeculativeBetweenReturn : 2;
  ...
  // TODO: Add dominator tree/assumption cache.
  ...
  bool CheckBetweenCallsiteAndReturn(const CallBase *CB, bool BailOnStore,
                                     bool BailOnLoad, bool BailOnNonSpeculative,
